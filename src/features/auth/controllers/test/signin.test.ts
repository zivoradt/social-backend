...
const USERNAME = 'Zivorad';
const PASSWORD = 'zivorad1';
const WRONG_USERNAME = 'zi';
const WRONG_PASSWORD = 'zi';
const LONG_PASSWORD = 'zivorad12345';
const LONG_USERNAME = 'zivoradtrickovic';
...
describe('SignIn', () => {
  ...
  /* it('should set session data for valid credentials and send correct json response', async () => {
    ...
    jest.spyOn(userService, 'getUserByAuthId').mockResolvedValue(authMock);
